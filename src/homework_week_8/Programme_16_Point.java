...
/**
 * You have to represent a point in 2D space. Write a class with the name point. The class need two fields
 * (instance variable)with name x and y of type int.
 * the class need to have two constructors. the first constructor does not have any parameters(no-arg constructor).
 ...
 * Method name getY without any parameters, it needs to return the value of yfield.
 * Method named setX with one parameter of type int, it needs to set the value of the x field.
 * Method named setY with one parameter of type int, it needs to set the value of the y field.
 * Method name distance without any parameters, it needs to return the distance between this point and point 0.0 as double
