 ...
 * sumFirstAndLastDigit (257); should return 9 the first digit is 2 and the last digit is 7
 * which gives us 2+7 and the sum is 9.
 * sumFirstAndLastDigit  (0) should return 0, the first digit and last digit is 0
 * since we only have 1 digit, which gives us 0+0 and the sum is 0
 * sumFirstAndLastDigit (5) should return 10, the first and the last digits is 5
 * since we have only one digit, which gives us 5+5 and the sum is 10.
 * sumFirstAndLastDigit (-10) should return -1, since the parameter is negative and need to be positive
 * Note:
 * the method sumFirstAndLastDigit need to be defined as public static
 */
