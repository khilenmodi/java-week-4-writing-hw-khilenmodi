...
/**
 * Write a class with the name SimpleCalculator. The class needs two fields(instance variable) with names firstNumber
 ...
 * Method named getAdditionResult witout any parameters, it need to return the result of adding the field value of firstNumber
 * and secondNumber.
 ...
 * Method named getMultiplicationResult without any parameters, it needs to return the result of multiplying the filed values
